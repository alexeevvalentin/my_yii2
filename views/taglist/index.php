...
$file_json = GenF::get_file_source(Yii::$app->basePath.'/views/taglist/kladr_json.txt');
$f_j_arr = Json::decode($file_json);

$file_json_full = GenF::get_file_source(Yii::$app->basePath.'/views/taglist/kladrfull.txt');
